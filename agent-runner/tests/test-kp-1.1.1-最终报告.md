...
| 2 | 特性设计文档 | ⚠️ | 目录存在 (`references/design-docs/`)，但仅有 README.md，无具体文档 |
| 3 | Oracle 知识库 | ✅ | 48 个文档匹配（内容扫描） |
| 4 | 测试用例 | ⚠️ | 目录存在 (`references/test-cases/`)，但仅有 README.md，无具体文档 |
| 5 | 源码 | ⚠️ | 目录存在 (`references/source/`)，但仅有 README.md，无具体文档 |
...
| 资料类型 | 状态 | 原因 |
|---|---|---|
| 特性设计文档 | 空结果 | `references/design-docs/` 目录存在，但仅有 README.md，无具体文档 |
| 测试用例 | 空结果 | `references/test-cases/` 目录存在，但仅有 README.md，无具体文档 |
| 源码 | 空结果 | `references/source/` 目录存在，但仅有 README.md，无具体文档 |
...
1. **补充环境数据**：在 `references/design-docs/`、`references/test-cases/`、`references/source/` 目录下添加具体文档
