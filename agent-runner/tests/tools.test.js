...
const { MCPClient } = require('../lib/tools/mcp-client');
const FileReader = require('../lib/tools/file-reader');
const FileWriter = require('../lib/tools/file-writer');
const ToolManager = require('../lib/tools/tool-manager');

const TEST_DIR = path.join(__dirname, '..', 'tmp', 'test-tools-' + Date.now());
