Created by 谢昭贤, last modified on 七月 26, 2024
...
-   [YDBRD-19180 【exp】支持指定字符集导出 ](#id-1.1.1【测试设计】YDBRD19180-YDBRD-19180【exp】支持指定字符集导出)  
-   [YDBRD-19179 【imp】支持指定字符集导入](#id-1.1.1【测试设计】YDBRD19180-YDBRD-19179【imp】支持指定字符集导入)  
-   [](#id-1.1.1【测试设计】YDBRD19180-)  
-   [1. 概述](#id-1.1.1【测试设计】YDBRD19180-1.概述)  
    -   [1.1 相关文档](#id-1.1.1【测试设计】YDBRD19180-1.1相关文档)  
    -   [1.2 特性说明](#id-1.1.1【测试设计】YDBRD19180-1.2特性说明)  
-   [2. 需求分析](#id-1.1.1【测试设计】YDBRD19180-2.需求分析)  
    -   [2.1 功能点分析](#id-1.1.1【测试设计】YDBRD19180-2.1功能点分析)  
    -   [2.2 应用场景](#id-1.1.1【测试设计】YDBRD19180-2.2应用场景)  
    -   [2.3 规格约束](#id-1.1.1【测试设计】YDBRD19180-2.3规格约束)  
-   [3. 详细测试设计](#id-1.1.1【测试设计】YDBRD19180-3.详细测试设计)  
    -   [3.1 测试设计方法](#id-1.1.1【测试设计】YDBRD19180-3.1测试设计方法)  
        -   [3.1.1 字符集影响位置细分](#id-1.1.1【测试设计】YDBRD19180-3.1.1字符集影响位置细分)  
        -   [3.1.2 字符集影响位置总结](#id-1.1.1【测试设计】YDBRD19180-3.1.2字符集影响位置总结)  
        -   [ASCII](#id-1.1.1【测试设计】YDBRD19180-ASCII)  
        -   [ISO 8859-1](#id-1.1.1【测试设计】YDBRD19180-ISO8859-1)  
        -   [GBK](#id-1.1.1【测试设计】YDBRD19180-GBK)  
        -   [UTF-8](#id-1.1.1【测试设计】YDBRD19180-UTF-8)  
        -   [GB18030](#id-1.1.1【测试设计】YDBRD19180-GB18030)  
    -   [3.2 详细测试设计](#id-1.1.1【测试设计】YDBRD19180-3.2详细测试设计)  
        -   [3.2.1 DFX测试](#id-1.1.1【测试设计】YDBRD19180-3.2.1DFX测试)  
        -   [3.2.2 等价类](#id-1.1.1【测试设计】YDBRD19180-3.2.2等价类)  
-   [4. 测试用例](#id-1.1.1【测试设计】YDBRD19180-4.测试用例)  
    -   [4.1 冒烟用例](#id-1.1.1【测试设计】YDBRD19180-4.1冒烟用例)  
    -   [4.2 文本用例](#id-1.1.1【测试设计】YDBRD19180-4.2文本用例)  
-   [5. 测试框架设计](#id-1.1.1【测试设计】YDBRD19180-5.测试框架设计)  
-   [6. 测试环境说明](#id-1.1.1【测试设计】YDBRD19180-6.测试环境说明)  
-   [7. 工作量评估](#id-1.1.1【测试设计】YDBRD19180-7.工作量评估)  
...
[X_文本用例模板.xlsx](https://pingcode.yasdb.com/atlas/file/origin-url?version=undefined&action=download&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..zHOIsFqtEAKoT5peNEsyRYx2CNxzDDrGROOMV6uzjDA)
...
[YDBRD-22421.xlsx](https://pingcode.yasdb.com/atlas/file/origin-url?version=undefined&action=download&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Cl2nSBBkVBLrJ2fmpPKt0Tc957EsQ2gqPwGMyrcTvWg)

 (application/vnd.openxmlformats-officedocument.spreadsheetml.sheet)    


[TESTCASE_YDBRD-22421.csv](https://pingcode.yasdb.com/atlas/file/origin-url?version=undefined&action=download&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..KypnyNINwOhlxdUGX64EnBNIaFvhAWIXB5E-r9wCnaQ)
