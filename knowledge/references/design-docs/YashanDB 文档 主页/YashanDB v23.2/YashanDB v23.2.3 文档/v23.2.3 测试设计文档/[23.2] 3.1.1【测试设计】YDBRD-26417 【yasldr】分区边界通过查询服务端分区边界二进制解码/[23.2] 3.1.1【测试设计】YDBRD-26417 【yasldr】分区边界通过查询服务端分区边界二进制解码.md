Created by 谢昭贤, last modified on 五月 28, 2024
...
-   [YDBRD-26417 【yasldr】分区边界通过查询服务端分区边界二进制解码](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-YDBRD-26417【yasldr】分区边界通过查询服务端分区边界二进制解码)  
-   [](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-)  
-   [1. 概述](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-1.概述)  
    -   [1.1 相关文档](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-1.1相关文档)  
    -   [1.2 特性说明](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-1.2特性说明)  
-   [2. 需求分析](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-2.需求分析)  
    -   [2.1 功能点分析](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-2.1功能点分析)  
    -   [2.2 应用场景](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-2.2应用场景)  
    -   [2.3 规格约束](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-2.3规格约束)  
-   [3. 详细测试设计](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-3.详细测试设计)  
    -   [3.1 测试设计方法](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-3.1测试设计方法)  
    -   [3.2 详细测试设计](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-3.2详细测试设计)  
        -   [3.2.1 DFX测试](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-3.2.1DFX测试)  
        -   [3.2.2 等价类](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-3.2.2等价类)  
-   [4. 测试用例](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-4.测试用例)  
    -   [4.1 冒烟用例](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-4.1冒烟用例)  
    -   [4.2 文本用例](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-4.2文本用例)  
-   [5. 测试框架设计](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-5.测试框架设计)  
-   [6. 测试环境说明](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-6.测试环境说明)  
-   [7. 工作量评估](#id-[23.2]3.1.1【测试设计】YDBRD26417【yasldr】分区边界通过查询服务端分区边界二进制解码-7.工作量评估)  
...
[YDBRD-26417.xlsx](https://pingcode.yasdb.com/atlas/file/origin-url?version=undefined&action=download&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..dK7XKfqrho-VNl0gm3kErdJXAj4yfBUBxkcVZOJMuJI)
...
[X_文本用例模板.xlsx](https://pingcode.yasdb.com/atlas/file/origin-url?version=undefined&action=download&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..hzDAmfZg_3uyc3ICmxZ_-XV-IulnJalSsdkrwQ6oI3g)

 (application/vnd.openxmlformats-officedocument.spreadsheetml.sheet)    


[YDBRD-22421.xlsx](https://pingcode.yasdb.com/atlas/file/origin-url?version=undefined&action=download&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..XrLcceffMo7FLj-XL6ATscRX58EpuNEURK4v--gCPfc)

 (application/vnd.openxmlformats-officedocument.spreadsheetml.sheet)    


[TESTCASE_YDBRD-22421.csv](https://pingcode.yasdb.com/atlas/file/origin-url?version=undefined&action=download&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..amh4PV1e3JO7WPHwKpmoRhxqL3QuoI-M2yvgd6DL7sw)

 (text/csv)    


[YDBRD-26417.xlsx](https://pingcode.yasdb.com/atlas/file/origin-url?version=undefined&action=download&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..AbCgSonSCgpI_fK8kseJnEA0U0Nl8w36wvJmOow4aEo)
...
|  [](null)  ,组合分区,list hash,range hash,hash list ,hash range ,hash hash ,Posted by xiezhaoxian at 五月 14, 2024 14:32|
|---|
|  [](null)  ,一、相关视图：,1、考虑视图本身元数据是否正确,  
,2、新增视图、考虑数据库升级,  
,  
,  
,3、场景校验，视图权限。,详细列出相关,若无ALL_TABLE_PARTITIONS权限，无法导入,无效等价类补充,表的所属用户与导入用户，权限不同,用户1 创建分区表，使用用户2 给用户1的表导数据。   **给用户2操作用户1表的权限。**,  [GRANT.html](https://cod-doc.yasdb.com/yashandb/23.2/zh/%E5%BC%80%E5%8F%91%E6%89%8B%E5%86%8C/SQL%E5%8F%82%E8%80%83%E6%89%8B%E5%86%8C/SQL%E8%AF%AD%E5%8F%A5/GRANT.html)  ,二、兼容性,版本兼容性,23.2.1 的客户端与23.2.2补丁数据库的兼容性,23.2.1客户端、23.2.2服务端,23.2.2客户端、23.2.1服务端,  
,  
,三、稳定函数、可变函数,考虑常用函数（转换函数）,Posted by xiezhaoxian at 五月 14, 2024 14:46|
|  [](null)  ,分区条件、,构造： csv的值，导入后对应的分区,  
,多个分区键,Posted by xiezhaoxian at 五月 14, 2024 14:47|
|  [](null)  ,已补充到测试设计,Posted by xiezhaoxian at 五月 14, 2024 15:00|
|  [](null)  ,已补充到测试设计,Posted by xiezhaoxian at 五月 14, 2024 15:03|
|  [](null)  ,已补充到测试设计,Posted by xiezhaoxian at 五月 14, 2024 15:06|
