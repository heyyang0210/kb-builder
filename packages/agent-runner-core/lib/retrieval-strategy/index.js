...
class RetrievalStrategy {
  constructor(basePath, toolManager = null) {
    ...
    this.references = {
      designDocs: path.join(basePath, 'knowledge/references', 'design-docs'),
      oracleKb: path.join(basePath, 'knowledge/references', 'oracle-kb'),
      testCases: path.join(basePath, 'knowledge/references', 'test-cases'),
      sourceCode: path.join(basePath, 'knowledge/references', 'source')
    };
  }
