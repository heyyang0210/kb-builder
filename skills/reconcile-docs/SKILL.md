...
5. Read `references/reconciliation-rules.md` before interpreting the machine report. Read `references/output-contracts.md` before editing or validating generated artifacts.
...
python3 skills/reconcile-docs/scripts/reconcile_docs.py answer --run-dir <path> --question-id <id> --decision accept --reason "已确认业务原因" --operator "<name>"
...
- `references/reconciliation-rules.md`: evidence hierarchy, state rules, and confirmation policy.
- `references/output-contracts.md`: configuration and artifact schemas.
