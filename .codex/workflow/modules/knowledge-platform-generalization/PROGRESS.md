...
| TASK-KPG-01 | 编写通用平台总体架构与迁移设计 | 待开始 | TASK-KPG-00 已完成，可开始 |
| TASK-KPG-02 | 定义企业能力包配置契约与校验规则 | 待开始 | 等待 TASK-KPG-01 |
...
仅执行 TASK-KPG-01：编写通用平台总体架构与迁移设计。设计冻结前不实施配置契约或业务代码改造。
