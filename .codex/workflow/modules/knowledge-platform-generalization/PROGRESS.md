...
> 更新日期：2026-08-27
> 总体状态：阶段 A、B 已完成，TASK-KPG-05 已完成，准备迁移资料加工链
> 状态单一入口：本文
...
| Agent/Skill/Prompt/模板 | 多目录配置与文件化资源 | 企业能力包版本化引用 | 文档生成链已接入；资料加工待 TASK-KPG-06 |
...
进入 TASK-KPG-06：将资料清洗与知识加工改为企业配置驱动。复用已冻结的 profile 资源边界和追溯字段，不修改 TASK-KPG-05 已保持的旧 API、任务状态和输出结构。
