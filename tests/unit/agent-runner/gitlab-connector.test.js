...
} = require('../../../packages/agent-runner-core/lib/gitlab-connector');
...
describe('GitLab connector', () => {
  ...
  test('projects legacy connections with derived display fields', () => {
    ...
    const item = require('../../../packages/agent-runner-core/lib/gitlab-connector').sanitizeConnection(readConfig(file).connections[0]);
