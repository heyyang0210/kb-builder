 ...
 *
 * 用法：
 *   node tests/unit/agent-runner/run-preprocessing-tests.js # 运行全部预处理测试
...
const PREPROCESSING_TESTS = [
  ...
  'tests/unit/agent-runner/preprocessing/fidelity-evaluator.test.js',
  ...
  'tests/unit/agent-runner/preprocessing/html-adapter.test.js',
  'tests/unit/agent-runner/preprocessing/pdf-adapter.test.js',
  'tests/unit/agent-runner/preprocessing/docx-adapter.test.js',
  'tests/unit/agent-runner/preprocessing/excel-adapter.test.js',
  'tests/unit/agent-runner/preprocessing/pptx-adapter.test.js',
  'tests/unit/agent-runner/preprocessing/archive-adapter.test.js',
  // 单元测试 - 适配器链
  'tests/unit/agent-runner/preprocessing/adapter-chain.test.js',
  // 单元测试 - 质量、分类和索引
  'tests/unit/agent-runner/preprocessing/quality-filter.test.js',
  'tests/unit/agent-runner/preprocessing/feature-classifier.test.js',
  'tests/unit/agent-runner/preprocessing/vector-and-graph-index.test.js',
  'tests/unit/agent-runner/preprocessing/hybrid-retriever.test.js',
  // 集成测试
...
const testPaths = PREPROCESSING_TESTS.map(t => path.resolve(ROOT_DIR, t)).join(' ');
...
try {
  ...
  if (report) {
    try {
      execSync('node tests/unit/agent-runner/preprocessing/generate-report.js', {
        stdio: 'inherit',
        cwd: ROOT_DIR
      });
