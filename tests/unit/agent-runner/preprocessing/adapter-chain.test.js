...
const { HtmlAdapter } = require('../../../../packages/agent-runner-core/lib/preprocessing/cleaners/html-adapter');
const { PdfAdapter } = require('../../../../packages/agent-runner-core/lib/preprocessing/cleaners/pdf-adapter');
const { DocxAdapter } = require('../../../../packages/agent-runner-core/lib/preprocessing/cleaners/docx-adapter');
