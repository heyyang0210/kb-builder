...
```bash
python scripts/pingcode/processing/diagnostics/knowledge_extraction_timeout.py \
  --task-id training_eab455f5e69e40ec \
  --chunk-id 83dc61836bc209e77056f0ff:0 \
  --case-file scripts/pingcode/processing/diagnostics/knowledge-extraction-timeout-cases.json
```
