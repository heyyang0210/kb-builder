...
source = root / 'scripts/pingcode/runtime/web/spaces/positive/batches/batch_31583e4c802a4b83/pages/1d95fbc3-知识服务全景图.md'
target = root / 'agent-runner/config/knowledge-assets.json'
rows = []
