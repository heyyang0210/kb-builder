Created by 张旭涛, last modified on 四月 16, 2024
...
show all 列出这个文本文件的配置路径。

然后执行原始的分布式restore 命令  restore cluster 恢复分布式集群。
...
1. backupset$ 新增字段BS_KEY标识唯一的备份集，分布式下同一备份集的BSKEY是一致的
...
1. 其
1. 他节点的详细信息按行读取，按逗号分隔每个配置项，  以key=value的形式解析具体的配置项
...
分布式端拉起只nomount之后，执行yasbak命令获取配置文件。并自动导入至catalog中。（目前设计是集成到清理环境至所有节点至nomount状态的命令中）
...
[image2023-11-15_9-19-1.png](https://pingcode.yasdb.com/atlas/file/origin-url?version=undefined&action=download&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Qge0Cv7DqxCEC8ehNnCCmvWiNiTzNPsV2qdEiQTDL3A)

 (image/png)    


[image2023-11-15_9-18-5.png](https://pingcode.yasdb.com/atlas/file/origin-url?version=undefined&action=download&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..C09joXzjQ0BRT0T1fqmh_tEJo25AliamF31CdthOQmM)

 (image/png)    


[image2023-11-15_9-17-30.png](https://pingcode.yasdb.com/atlas/file/origin-url?version=undefined&action=download&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..gkVh-YZ6Gx4nZM_pNCCSCZw8PDykGvnejCDvUvqhY8U)
