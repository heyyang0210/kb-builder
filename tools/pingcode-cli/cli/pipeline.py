...
用法：
  python3 tools/pingcode-cli/cli/pipeline.py              # 处理所有目标
  python3 tools/pingcode-cli/cli/pipeline.py --headless   # 无头模式
  python3 tools/pingcode-cli/cli/pipeline.py --target 0   # 只处理第一个目标
"""
