...
用法：
  ...
  python3 tools/pingcode-cli/cli/space_crawl.py --space YASDOC --keyword "存储"
...
from space_crawler import SpaceCrawler
...
示例：
  ...
  python3 tools/pingcode-cli/cli/space_crawl.py --space YASSTORAGE --verbose
    ...
    parser.add_argument('--output', help='输出目录（默认 tools/pingcode-cli/data）')
    ...
    if args.output:
        ...
        output_dir = PROJECT_ROOT / 'runtime' / 'pingcode' / 'cli'
