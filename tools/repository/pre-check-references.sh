...
# 使用：bash tools/repository/pre-check-references.sh
# ============================================================
...
REQUIRED_DIRS=(
    "knowledge/references/oracle-kb"
    "knowledge/references/design-docs"
    "knowledge/references/test-cases"
    "knowledge/references/source"
    "knowledge/references/mcp-yashandb-kb"
)
...
ORACLE_KB_DIR="${REPO_ROOT}/knowledge/references/oracle-kb"
...
REQUIRED_SKILLS=(
    "knowledge/skills/00-通用生成-skill.md"
    "knowledge/skills/01-理论机制-skill.md"
    "knowledge/skills/02-实战调优-skill.md"
    "knowledge/skills/03-架构对比-skill.md"
    "knowledge/skills/04-运维SOP-skill.md"
    "knowledge/skills/05-SQL开发参考-skill.md"
    "knowledge/skills/06-兼容性差异-skill.md"
)
...
REQUIRED_TEMPLATES=(
    "knowledge/templates/01-通用基础模板.md"
    "knowledge/templates/02-理论机制类模板.md"
    "knowledge/templates/03-实战调优类模板.md"
    "knowledge/templates/04-架构对比类模板.md"
    "knowledge/templates/05-运维SOP类模板.md"
    "knowledge/templates/06-SQL开发参考类模板.md"
    "knowledge/templates/07-兼容性差异类模板.md"
)
