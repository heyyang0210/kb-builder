...
from .pingcode_core_loader import ensure_pingcode_core


APP_DIR = Path(__file__).resolve().parent
REPOSITORY_ROOT = APP_DIR.parents[2]
PINGCODE_DIR = REPOSITORY_ROOT / "packages" / "pingcode-core"
CONFIG_DIR = REPOSITORY_ROOT / "config" / "pingcode"
ensure_pingcode_core(REPOSITORY_ROOT)
